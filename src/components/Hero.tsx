...
const Hero: React.FC = () => {
  ...
  return (
    <>
      ...
      <section
        ref={sectionRef}
        className="bg-gradient-to-b from-white to-primary-50 py-12 md:py-24 relative overflow-hidden"
        style={{
        ...
        <div className="container mx-auto px-4 h-full flex flex-col">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between relative z-10 h-full">
            ...
            <div className="w-full md:w-1/2 mb-10 md:mb-0 text-center md:text-left">
              ...
              {/* Action buttons */}
              <div className="flex flex-col space-y-3 mb-6 justify-center md:justify-start sm:flex-row sm:space-y-0 sm:space-x-4">
                <a 
                  href="#pricing"
          ...
          <div className="md:hidden w-full mt-6 mb-6">
